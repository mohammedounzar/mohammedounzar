...
- Building intelligent systems (RAG, ML, NLP)  
- Designing scalable backend architectures  
- Learning new tools every week and breaking things to understand them  
...
### 🔹 **DevOps Log Persistence Optimization**
- Compared SQL vs NoSQL performance for DevOps logs  
- Built log ingestion pipeline with **Logstash → Elasticsearch/Kibana**  
- Benchmarked MySQL, MongoDB, and Elasticsearch  
- Containerized setup with Docker & Jenkins

---

### 🔹 **AI-Based Mobile Health Monitoring App**
- Built Android app for runner performance tracking  
- IoT device streams health metrics in real-time  
- ML model detects abnormal behavior (heart rate, breathing patterns)  
- Stack: Android Studio + Firebase + Raspberry Pi + Flask + Python
...
<p align="left">
  ...
  <a href="mailto:ounzarmohammed@gmail.com">
